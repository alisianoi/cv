...
\extrainfo{\href{https://github.com/all3fox}{https://github.com/all3fox}}
...
\section{Experience}
\cventry{2017}{Google Summer of Code}
...
\section{Projects}
\cventry{2017}{Lyra2 in Java}{bachelor thesis at the Vienna University of Technology}{}{}{Ported a memory-hard password hashing scheme called Lyra2 from C to Java. Used the \href{https://github.com/all3fox/lyra2-java/}{Java project} to develop an Android \href{https://github.com/all3fox/lyra2-mobile}{application} to demonstrate password hashing on smartphones. \\ (Java/C/Android/Python/Jupyter Notebook)}
...
%% \section{Skills}
%% \cvitemwithcomment{Python}{scikit-learn, SciPy Stack, Jupyter, Nose}{ML experience: SVM, PCA, cross-validation, etc.}
%% \cvitemwithcomment{C++}{Qt, Boost.Test, CMake}{Template metaprogramming experience.}
%% \cvitemwithcomment{Java}{JavaFX, Spring, JUnit, Maven}{Desktop application development.}
